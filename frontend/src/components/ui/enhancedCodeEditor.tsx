  ...
  if (collapsible && isCollapsed) {
    return (
      <div className={`border border-gray-300 dark:border-gray-600 rounded-lg ${className}`}>
        <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600">
    ...
    <div className={`relative border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden ${className}`}>
      ...
      <div className="relative" style={{ height: height + 'px' }}>
        <div className="flex h-full">
          {/* Line numbers */}
          {showLineNumbers && (
            <div className="bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-600 text-right text-gray-500 dark:text-gray-400 select-none min-w-[3rem] flex-shrink-0">
              <div
                ref={lineNumbersRef}
          ...
          {/* Editor area */}
          <div className="flex-1 relative bg-gray-50 dark:bg-gray-800 border-r">
            ...
            <textarea
              ...
              className={`absolute inset-0 w-full h-full border-none outline-none resize-none ${
                language !== 'plaintext' ? 'bg-transparent text-transparent caret-gray-900 dark:caret-gray-100' : 'bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100'
